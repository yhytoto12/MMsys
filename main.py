...
train_loader, val_loader, test_loader = load_cifar(device)
...
history += fit(args.n_epoch, args.lr, args.momentum, args.weight_decay, args.milestones, args.gamma, model, train_loader, val_loader)
